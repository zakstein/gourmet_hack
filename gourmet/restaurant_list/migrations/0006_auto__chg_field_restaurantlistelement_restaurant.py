...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RestaurantListElement.restaurant'
        db.alter_column('restaurant_list_restaurantlistelement', 'restaurant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant_list.Restaurant'], null=True))


    def backwards(self, orm):

        # Changing field 'RestaurantListElement.restaurant'
        db.alter_column('restaurant_list_restaurantlistelement', 'restaurant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['restaurant_list.Restaurant']))
    ...
    models = {
        ...
        'restaurant_list.restaurantlistelement': {
            ...
            'restaurant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant_list.Restaurant']", 'null': 'True'}),
