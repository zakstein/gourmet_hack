...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RestaurantListElement.restaurant_name'
        db.add_column(u'restaurant_list_restaurantlistelement', 'restaurant_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RestaurantListElement.restaurant_name'
        db.delete_column(u'restaurant_list_restaurantlistelement', 'restaurant_name')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 19, 18, 40, 29, 945116)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 19, 18, 40, 29, 944719)'}),
        ...
        u'restaurant_list.restaurantlistelement': {
            ...
            'restaurant_name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'})
        }
    }
