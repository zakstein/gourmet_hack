...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('restaurant_list_restaurant', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)

        # Adding index on 'Restaurant', fields ['address']
        db.create_index('restaurant_list_restaurant', ['address'])


    def backwards(self, orm):
        
        # Removing index on 'Restaurant', fields ['address']
        db.delete_index('restaurant_list_restaurant', ['address'])
        ...
        db.delete_column('restaurant_list_restaurant', 'country')
