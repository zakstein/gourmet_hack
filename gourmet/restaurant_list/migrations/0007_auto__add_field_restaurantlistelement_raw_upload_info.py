...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RestaurantListElement.raw_upload_info'
        db.add_column('restaurant_list_restaurantlistelement', 'raw_upload_info', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RestaurantListElement.raw_upload_info'
        db.delete_column('restaurant_list_restaurantlistelement', 'raw_upload_info')
